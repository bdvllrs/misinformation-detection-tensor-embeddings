...
config = load_config()
articleTensor = ArticleTensor(config)
...
for meth in enumerate(methods):
    ...
    for k in ratios:
        ...
        np.save('../Stats/{}_{}_method_{}_ration_precision_val stats_mean'.format(meth[1][0],meth[1][1],k), precision_mean)
        np.save('../Stats/{}_{}_method_{}_ration_precision_val stats_std'.format(meth[1][0],meth[1][1],k), precision_std)
        ...
        np.save('../Stats/{}_{}_method_{}_ration_f1_score_val stats_mean'.format(meth[1][0],meth[1][1],k), f1_score_mean)
        np.save('../Stats/{}_{}_method_{}_ration_f1_score_val stats_std'.format(meth[1][0],meth[1][1],k), f1_score_std)
