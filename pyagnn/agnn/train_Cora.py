...
if __name__ == "__main__":
    ...
    test_idx_reorder = parse_index_file("/media/benamira/19793564030D4273/MCsBackup/3A/OMA/NGSA/project/pytorch-AGNN/data/"+name_dataset+"/raw/ind.{}.test.index".format(dataset))
    ...
    idx_test = range(idx_test[0],idx_test[-1])
